...
class OrderCost extends StatefulWidget {
  final String idUser;
  ...
  @override
  _OrderCostState createState() => _OrderCostState();
}

class _OrderCostState extends State<OrderCost> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: CustomAppBar(
          label: 'Transaksi ${widget.noOrder}',
        ),
        body: ListView(
